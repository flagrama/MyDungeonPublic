...
public class MenuManager : MonoBehaviour
{
    ...
    public void LoadGame()
    {
        ...
        {
#if UNITY_EDITOR
            Debug.Log(File.ReadAllText(Application.persistentDataPath + "/save.sav"));
#endif
            Save save = JsonUtility.FromJson<Save>(File.ReadAllText(Application.persistentDataPath + "/save.sav"));
